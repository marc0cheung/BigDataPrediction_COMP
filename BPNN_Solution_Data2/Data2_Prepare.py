...
def prepareTrainingData():
    ...
    sourceData.to_csv('data2_training_clean.csv', index=False, header=True)
...
def prepareValidationData():
    ...
    sourceData.to_csv('data2_validation_clean.csv', index=False, header=True)
...
def prepareTestData():
    ...
    sourceData.to_csv('data2_test_clean.csv', index=False, header=True)
